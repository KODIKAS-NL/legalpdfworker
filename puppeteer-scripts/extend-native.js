...
//Extend Object (toString)
const origToString = Object.prototype.toString;
Object.prototype.toString = function () {
    return (typeof this.amount !== 'undefined' && this.amount !== '' && this.amount !== null)
        ? this.amount + ' ' + this.unit
        : origToString.call(this);
};
...
Object.defineProperties(String.prototype, {
    ...
    toDate: method(function () {
        ...
        var lang = global.lang || 'nl';
        var date = moment(this + '', null, lang);
        if (!date.isValid()) date = moment(this + '', 'L', lang);
...
function toCurrency(currency, useLocale) {
    var locale = useLocale || global.lang || 'nl';
    var number = typeof this === 'string' ? parseFloat(this) : this;

    currency = currency || global.currency || 'EUR';
    if (currencies[currency]) currency = currencies[currency]; // Covert currency symbol
...
function toNumber(precision, useLocale) {
    ...
    if (typeof useLocale === 'undefined') useLocale = global.lang || 'nl';
